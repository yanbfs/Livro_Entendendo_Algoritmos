01º Algoritmo - CONTAGEM REGRESSIVA (RECURSIVIDADE).JS
    Descrição:
...
Funções:
    ...
    2. tchau()
        Descrição: 
            • Esta função exibe uma mensagem de despedida no console.
        Parâmetros: 
            • Nenhum.
